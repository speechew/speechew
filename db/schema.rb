...
ActiveRecord::Schema.define(version: 20_210_402_122_827) do
  ...
  create_table 'knowledge_books', force: :cascade do |t|
    t.string 'code'
    t.string 'title'
    t.text 'content'
    t.boolean 'deleted', default: false
  ...
  create_table 'knowledge_chapters', force: :cascade do |t|
    t.integer 'knowledge_book_id', null: false
    t.string 'title'
    t.text 'content'
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['knowledge_book_id'], name: 'index_knowledge_chapters_on_knowledge_book_id'
  end
