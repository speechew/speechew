...
class KnowledgeBooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create knowledge_book' do
    assert_difference('KnowledgeBook.count') do
      post knowledge_books_url,
           params: { knowledge_book: { code: @knowledge_book.code, content: @knowledge_book.content,
                                       deleted: @knowledge_book.deleted, title: @knowledge_book.title } }
    end
  ...
  test 'should update knowledge_book' do
    patch knowledge_book_url(@knowledge_book),
          params: { knowledge_book: { code: @knowledge_book.code, content: @knowledge_book.content,
                                      deleted: @knowledge_book.deleted, title: @knowledge_book.title } }
